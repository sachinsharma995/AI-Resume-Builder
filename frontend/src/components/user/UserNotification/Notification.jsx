...
import { ArrowLeft, Search, Trash2, CheckCircle, AlertCircle, Info, Clock, Bell, Zap } from 'lucide-react';
...
const Notification = () => {
    ...
    const { notifications, markAsRead, deleteNotification, clearAll, markAllAsRead } = useUserNotifications();
                            ...
                            <div className="px-8 py-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-purple-50 rounded-lg p-4 border border-purple-100/50">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className={`w-6 h-6 ${getAvatarColor(selectedNotification.user)} rounded-full flex items-center justify-center text-xs font-bold text-white shadow-md`}>
...
const NotificationCard = ({ notif, index, onDelete, onClick, getTypeIcon, getAvatarColor }) => {
    return (
        <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200/30">
                        ...
                        <div className="flex items-center gap-2">
                            <div className={`w-5 h-5 ${getAvatarColor(notif.user)} rounded-full flex items-center justify-center text-xs font-bold text-white shadow-md`}>
                                {notif.user?.charAt(0)}
                            </div>
