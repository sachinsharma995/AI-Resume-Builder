        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              <motion.div
                variants={fadeUp}
                className="inline-flex items-center gap-2 px-6 py-2.5 mb-8 rounded-full bg-white border border-blue-100 shadow-sm"
              >
              ...
              <motion.h1
                variants={fadeUp}
                className="text-5xl md:text-6xl font-bold text-[#1a2e52] mb-6 tracking-tight font-jakarta leading-[1.1]"
              >
              ...
              <motion.p
                variants={fadeUp}
                className="text-lg md:text-xl text-gray-500 mb-10 max-w-2xl leading-relaxed mx-auto lg:mx-0"
              >
            ...
            >
              <div className="relative w-full max-w-[450px]">
                ...
                <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-orange-100 flex items-center justify-center shadow-sm">
      ...
      <section className="px-6 pb-24 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="bg-[#1a2e52] rounded-[3rem] p-8 md:p-20 text-center text-white relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="w-full sm:w-auto px-10 py-5 bg-white text-[#1a2e52] rounded-2xl font-bold text-lg shadow-xl hover:shadow-white/20 flex items-center justify-center gap-2 transition-transform duration-300 ease-out hover:scale-105"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-10 py-5 bg-transparent border-2 border-white/20 text-white rounded-2xl font-bold text-lg hover:bg-white/10 hover:border-white hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  Create Account
                </button>
              </div>
