...
const CVFormattingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-['Outfit'] text-[#1a2e52] selection:bg-blue-100 overflow-x-hidden">
      <NavBar />
      {/* --- 1. HERO SECTION --- */}
      <section className="relative px-6 pt-12 md:pt-16 overflow-hidden bg-white">
        {/* Decorative Blurs */}
        ...
        <div className="relative z-10 mx-auto max-w-7xl pt-6 md:pt-10">
          <div className="flex flex-col items-center gap-10 md:gap-14 lg:gap-16 lg:flex-row lg:text-left">            {/* LEFT CONTENT */}
           <div className="flex-1 text-center xl:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 md:mb-8 rounded-full bg-blue-50">
                <Layers size={14} className="text-[#0077cc]" />
                <span className="text-[10px] md:text-xs font-black tracking-widest text-[#0077cc] uppercase">
                  Document Architecture
                </span>
              </div>

              {/* FIXED MOBILE HEADING SIZE */}
              <h1 className="mb-4 text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black tracking-tight xl:leading-[1.1] font-jakarta">
                Professional CV <br />
                <span className="text-[#0077cc]">Re-Architected.</span>
              </h1>

              {/* FIXED MOBILE PARAGRAPH SIZE */}
              <p className="max-w-md mx-auto mb-8 text-base sm:text-lg md:text-xl font-medium leading-relaxed text-gray-500 lg:mx-0">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 text-sm sm:text-base md:text-lg bg-gradient-to-r from-[#e65100] to-[#f4511e] text-white rounded-xl font-bold transition-all duration-300 shadow-[0_10px_25px_rgba(230,81,0,0.3)] hover:-translate-y-1 active:scale-95 mx-auto lg:mx-0"
              >
            ...
            {/* RIGHT IMAGE */}
           <div className="relative hidden md:flex flex-1 w-full max-w-[450px] md:max-w-[550px]">
              <img
                src={CV}
