        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div onClick={() => navigate('/')} className="cursor-pointer transition-transform hover:scale-105">
              <div className="w-[160px] h-10 bg-gradient-to-r from-[#0077cc] to-[#e65100] rounded-lg flex items-center justify-center font-black text-white text-sm">
                UptoSkills
              </div>
            </div>
                ...
                >
                  ...
                  <div className="relative p-6 bg-gradient-to-br from-gray-50 to-white border-b-2 border-gray-100">
                    ...
                    <div className="absolute top-6 right-6 w-8 h-8 rounded-full bg-gray-100 group-hover:bg-[#0077cc] flex items-center justify-center transition-all duration-300">
                      <i className={`fas fa-chevron-down text-gray-600 group-hover:text-white transition-all duration-300 ${
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className={`flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-[#0077cc] to-[#e65100] flex items-center justify-center text-white transition-all duration-300 ${
